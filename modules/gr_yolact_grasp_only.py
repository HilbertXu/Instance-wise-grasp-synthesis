...
class PredictionModule(nn.Module):
    ...
    def forward(self, x):
        ...
        return conf, box, gr_pos_coef, gr_sin_coef, gr_cos_coef, gr_wid_coef
...
class GraspYolact(nn.Module):
    ...
    def forward(self, img, box_classes=None, masks_gt=None, pos_mask_gt=None, qua_mask_gt=None, sin_mask_gt=None, cos_mask_gt=None, wid_mask_gt=None):
        ...
        for aa in outs:
            class_p, box_p, gr_pos_coef_p, gr_sin_coef_p, gr_cos_coef_p, gr_wid_coef_p = self.prediction_layers(aa)
        ...
        if self.training:
            ...
            return class_pred, box_pred, gr_pos_coef_pred, gr_sin_coef_pred, gr_cos_coef_pred, gr_wid_coef_pred, proto_out
    ...
    def compute_loss(
        ...
        return loss_c, loss_b, loss_g_pos, loss_g_qua, loss_g_ang, loss_g_wid, loss_s
